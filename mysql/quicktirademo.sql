...
(15, 'good job', 'krleian quismon', 'krek@gmail.com', 'read');
...
(14, 'aisen', 'aisen rodis', '61', 'ajflsfagasgaggag', 'Inaccurate Information ', 'josh velayo', 'read'),
(15, 'peppa', 'peppa bunyi', '59', 'sasad adasdad ad', 'Violation of Terms', 'Rap Baranda', 'read'),
(16, 'ken', 'ken beato', '58', 'asdasd', 'Inaccurate Information ', 'Rap Baranda', 'read'),
(17, 'ken', 'ken beato', '58', 'asdasd', 'Inaccurate Information ', 'Rap Baranda', 'read'),
(18, 'aisen', 'aisen rodis', '56', 'asdasd', 'Inaccurate Information ', 'Rap Baranda', 'read');
...
(15, 'marco abella', 'marco@gmail.com', 'marco', '$2y$10$RFDa8s9m7bECBuZ8VMuZwODAaoTZiSHIUtt2clKztkQLTZFU6wBq2', '09099897185', 'landlord', '6756e27d8715e.jpg', 'yes', 'active');
...
(62, 15, 'house for rent', 'image_6756e41eafb859.53195685.jpg', 5000, 'fasfa asfasfasf afsf', 'Poblacion', 1, 1, 200, '12/09/24', 'blk 1 lot 2', 'inactive', 14.328413525081700, 120.935380249429740);
...
(159, 62, 'image_6756e41eafe288.28692992.jpg'),
(160, 62, 'image_6756e41eaffaf4.53239423.jpg');
...
(18, 62, 15, 22, 3, '2024-12-11', '2025-01-10');
...
(2, 'krelian quimson', 'quimsonkrelian@gmail.com', 'krel', '$2y$10$u50CtunPDTprF.S0QcCN4uypqdMubOjEr.zd.nB4PHtLAB2itFB7W', '09099897185', 'tenant', '6722ffec2d1a4.jpg', 'yes', 'banned'),
...
(22, 'Rap Baranda', 'rap@gmail.com', 'rap', '$2y$10$MfHOyuXzXBuHMBJi3LqQCOhsTOS8aYA4N2feW7s34iwKngqmsOUTO', '09214904468', 'tenant', '6756db91aa9a6.JPG', 'yes', 'active');
...
--
ALTER TABLE `convo`
  MODIFY `convo_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT for table `favorite`
--
ALTER TABLE `favorite`
  MODIFY `favorite_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;
...
--
ALTER TABLE `tenant_applications`
  MODIFY `apply_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
COMMIT;
